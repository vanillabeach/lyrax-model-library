...
const pdb_structure_1 = require("../pdb/pdb_structure");
...
END`;
const atom1 = new atom_1.default({
    id: "atom1",
    serialNumber: 1,
...
const atom2 = new atom_1.default({
    id: "atom2",
    serialNumber: 2,
...
const atom3 = new atom_1.default({
    id: "atom3",
    serialNumber: 3,
...
const bond1 = new bond_1.default({
    id: "bond1",
    firstId: atom1.id,
    secondId: atom2.id,
});
describe(molecule_1.default, () => {
    describe("constructor", () => {
        describe("default", () => {
            test("valid constructor with predefined values", () => {
                const molecule = new molecule_1.default({
                    id: "molecule1",
        ...
        describe("factory methods", () => {
            const examplePdbStructure = pdb_structure_1.default.fromPDBTextFile(PDB_FILE_AS_TEXT);
            describe(molecule_1.default.fromPDBStructure, () => {
                const molecule = molecule_1.default.fromPDBStructure("molecule1", examplePdbStructure);
                expect(molecule).not.toBe(null);
        ...
        describe("other static methods", () => {
            describe(molecule_1.default.getTheDistanceBetweenTwoAtoms, () => {
                test("works with valid numbers", () => {
                    const distanceBetweenAtom1AndAtom2 = molecule_1.default.getTheDistanceBetweenTwoAtoms(atom1, atom2);
                    expect(Number(distanceBetweenAtom1AndAtom2.toFixed(2))).toEqual(2.24);
                });
                test("captures invalid numbers", () => {
                    const nullAtom = new atom_1.default({ id: "nullAtom" });
                    const distanceBetweenAtom1AndNullAtom = molecule_1.default.getTheDistanceBetweenTwoAtoms(atom1, nullAtom);
